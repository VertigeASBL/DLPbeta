...
<title>Edition du compte d'un Spectateur</title>
...
<h1>Compte du spectateur <?php echo $prenom_spectateur . ' ' . $nom_spectateur ; ?></h1>
...
if (isset($_POST['bouton_enregistrer']) AND ($_POST['bouton_enregistrer'] == 'Enregistrer'))
{
	...
	else
	{
		...
		$error_nom_spectateur = '<div class="error_form">Vous devez introduire votre nom</div>';
	}
	...
	{
		$sexe_spectateur = '';
		$rec .= '- Vous devez sélectionner votre sexe<br>';
		$error_nom_spectateur = '<div class="error_form">Vous devez sélectionner votre sexe</div>';
	}
	...
	else
	{
		...
		$error_description_longue_spectateur = '<div class="error_form">Vous devez introduire ici votre description complète</div>';
		$rec .= '- Vous devez introduire un texte descriptif de l\'événement<br>';
	}
	...
	{	
		...
		<p>&nbsp;</p><p>&nbsp;</p>
		<h1>Un Spectateur a modifié son profil</h1>
		<p>&nbsp;</p>';
...
?> <br /><strong>Avis approuv&eacute;s pour la saison actuelle</strong> :
	...
	<tr>
	  <td><strong>Pr&eacute;nom</strong><span class="champ_obligatoire">*</span> :	  <?php if (isset ($error_prenom_spectateur) AND $error_prenom_spectateur != NULL) {echo $error_prenom_spectateur ; } ?>	  </td>
	...
	<tr>
	  <td><strong>Nom</strong><span class="champ_obligatoire">*</span> :	  <?php if (isset ($error_nom_spectateur) AND $error_nom_spectateur != NULL) {echo $error_nom_spectateur ; } ?>	  </td>
	...
	<tr>
	  ...
	  <td align="center" valign="middle"><?php 		
			...
			{
				echo '<img src="../' . $folder_pics_spectateurs . 'vi_spect_' . $id . '_1.jpg" />';
			}
			else
			{
            ...
            <td><p>Image 
              <input name="source_pic_1" type="file" id="source_pic_1" />
  			  <br /><label>Effacer l'image<input type="checkbox" name="effacer_image1" /></label></p></td>
    </tr>
	<tr>
...
?></td>
	...
	<tr>
	  <td valign="middle"><strong>Sexe</strong><span class="champ_obligatoire">*</span> : </td>
	  <td>
...
?></td>
	...
	<tr>
      <td><strong>Lieu(x) culturel(s) favori(s)</strong> 
