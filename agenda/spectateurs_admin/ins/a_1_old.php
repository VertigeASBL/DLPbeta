...
<title>Inscription d'un SPECTATEUR</title>
...
<h1>Création d'un compte "spectateur"</h1>
...
<!-- <div class="menu_back">
<a href="../../../-Agenda-">Retour au site</a></div>
<div align="center">
  <p><strong>Ce formulaire d'inscription est destin&eacute; aux Spectateurs</strong>.
  Dans les autres cas, utilisez ces liens :  </p>
  <ul>
  <li>Vous souhaitez vous inscrire sur le site <a href="http://www.comedien.be/-se-connecter-">comedien.be</a> </li>
  <li>Vous souhaitez devenir un <a href="http://www.comedien.be/-Inscription-">lieux culturels affiliés</a></li>
</ul><br />
...
if (isset($_POST['bouton_enregistrer']) AND ($_POST['bouton_enregistrer'] == 'Enregistrer'))
{
	...
	else
	{
		...
		$error_prenom_spectateur = '<div class="error_form">Vous devez introduire votre prénom</div>';
	}
	...
	else
	{
		...
		$error_nom_spectateur = '<div class="error_form">Vous devez introduire votre prénom</div>';
	}
	...
	{	
		...
		VALUES ('$nom_spectateur', '$prenom_spectateur', '$pseudo_spectateur', '$e_mail_spectateur', '$tel_spectateur', '$log_spectateur', '$pw_spectateur', 'new')");
		...
		$corps="Bonjour " . html_entity_decode($prenom_spectateur) . " " . html_entity_decode($nom_spectateur) .", 

Votre compte de spectateur affilié à l'agenda de demandezleprogramme.be a bien été créé. 
Pour l'activer, rendez-vous sur " ;
		$corps.= 'cette page : http://www.demandezleprogramme.be/agenda/spectateurs_admin/edit_profile_spectateur.php. 
' ;
		$corps.= 'Pour vous connecter à votre compte, utilisez ce login  : ' . $log_spectateur . ' 
...
L'équipe de http://www.demandezleprogramme.be" ;
		...
		if ($test_mail)
		{
			...
			<br /> <br /> ous allez être redirigé vers votre nouveau compte personnel. 
			Complétez y les autres données concernant votre profie.
			<br /> <br />
			Si vous n\'êtes pas redirigé, cliquez sur 		 
			<a href="../edit_profile_spectateur.php">ce lien</a> afin de valider votre compte.<br><br>
			...
			$corps.='<b>Pr&eacute;nom</b> : ' . $prenom_spectateur . ' </p>';
		 ...
		 mail($retour_email_admin,$sujet,$corps,$entete);
			...
			// ********************************************************************************************
			$_SESSION['nom_spectateur'] = $nom_spectateur;
		    $_SESSION['prenom_spectateur'] = $prenom_spectateur;
			...
			echo '<meta http-equiv="refresh" content="4; url=../edit_profile_spectateur.php">' ;
...
?>
	...
	<form name="form1" method="post" action="" enctype="multipart/form-data">
	  <table width="450" border="1" align="center" cellpadding="5" cellspacing="0" class="table_spectateur" >
		<tr>
		...
		<tr>
		  <td>Pr&eacute;nom
		  <?php if (isset ($error_prenom_spectateur) AND $error_prenom_spectateur != NULL) {echo $error_prenom_spectateur ; } ?>	  </td>
		...
		<tr>
		  <td>Nom 
		  <?php if (isset ($error_nom_spectateur) AND $error_nom_spectateur != NULL) {echo $error_nom_spectateur ; } ?>	  </td>
		...
		<tr>
		  <td>T&eacute;l&eacute;phone <span class="mini">(facultatif)</span>		  <?php if (isset ($error_tel) AND $error_tel != NULL) {echo $error_tel ; } ?>	  </td>
      ...
      <td><input name="code" type=text id="code" size="5" maxlength="<?php echo $nb_car; ?>">
          <img src=im_gen.php?session=<?php echo $session; ?> hspace="10" align="top"> </td>
			...
			<tr class="table_public">
              ...
              Je d&eacute;clare accepter les <a href="/Mentions-legales-pour-Demandez-le?page=article-3">conditions g&eacute;n&eacute;rales d'utilisation (mentions l&eacute;gales)</a> d'utilisation de demandezleprogramme</label></td>
	    </tr>
		<tr>
