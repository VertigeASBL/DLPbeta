...
<title>Edition de la p&eacute;riode de repr&eacute;sentation de l'&eacute;v&eacute;nement</title>
...
<h1>Edition de la période de représentation de l'événement</h1>

<div class="menu_back"><a href="index_admin.php">Index Admin</a>
</div>
...
<p>&nbsp;</p>
		...
		if (isset($_POST['modif_form']) AND ($_POST['modif_form'] == 'Enregistrer'))
		{
			...
			echo '<br><br><br><div class="info">Les changements ont bien été enregistrés. <br>
			<a href="edit_event.php?id='. $id . '">Cliquez ici pour retourner à la fiche événement</a></div><br>' ;
		}
		...
		else
		{
			...
			?>		  </td>
				...
				<tr>
				  <td>
				  <div align="center"><br /><input name="modif_form" type="submit" id="modif_form" value="Enregistrer"><br /></div>		  </td>
				</tr>
		  </table>
		</form>
