...
if (isset($_POST['bouton_enregistrer']) AND ($_POST['bouton_enregistrer'] == 'Enregistrer'))
{
	...
	if (isset($_POST['description_courte_spectateur_chp']) AND ($_POST['description_courte_spectateur_chp'] != NULL)) 
	{
		...
		{	
			...
			$error_description_courte_spectateur = '<div class="error_form">La taille du texte "résumé 
	...
	if (isset($_POST['description_longue_spectateur_chp']) AND ($_POST['description_longue_spectateur_chp'] != NULL)) 
	{
		...
		{	
			...
			$error_description_longue_spectateur = '<div class="error_form">La taille du texte "résumé 
			de l\'événement" dépasse la limite autorisée (' . $max . 'caractères) . 
			Il y a ' . $char_en_trop . ' caractères en trop. Veuillez le raccourcir.</div>';
			$rec .= '- La taille du texte "résumé" de l\'événement dépasse la limite autorisée<br>';			
		}
...
<form name="form1" method="post" action="" enctype="multipart/form-data">
  <table width="450" border="1" align="center" cellpadding="5" cellspacing="0" class="data_table" >
	...
	?>
	<br />Avis approuvés pour la saison actuelle :
 ...
 ?>
	...
	<tr>
	  ...
	  <td><?php if (isset($pseudo_spectateur)){echo $pseudo_spectateur;}?>
        <span class="mini">(le pseudo ne peut pas être modifié car il fait le lien avec les AVIS)</span></td>
    </tr>
	<tr>
...
<option value="vide">Année</option>';
