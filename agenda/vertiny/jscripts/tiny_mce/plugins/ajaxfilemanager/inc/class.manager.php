...
class manager
{
	...
	{
		global $conf_sys_def_path ;  // stratmodif
		...
		{
			$this->currentFolderPath = $conf_sys_def_path;
		}
		$this->currentFolderPath = isUnderRoot(backslashToSlash((addTrailingSlash($this->currentFolderPath))))?backslashToSlash((addTrailingSlash($this->currentFolderPath))):$conf_sys_def_path;
